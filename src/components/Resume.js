...
export default function Resume() {
    ...
    const projectData=[
        ...
        {image:"https://i.imgur.com/cdt8z5B.gif",name:"Inaiwish Cleaning Services",desc:"A responsive website where different responsive aspects are displayed. Different components like slideshow, cards, login page forms etc are made using pure HTML CSS and JS.",viewLive:"https://tictactoe.siwani.com.np/tictactoe.html",seeCode:"https://github.com/santos-parajuli/InawishCleaningService"},
