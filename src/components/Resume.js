...
export default function Resume() {
    ...
    const projectData=[
        {image:"https://i.imgur.com/FampZw1.gif",name:"Instagram Clone",desc:"The project is build with ReactJs, TailwindCSS and Firebase. As the name suggests it's a clone of instagram where for now,Account Creation, Adding Post, Likes, Comment,Profile editing can be done. It is completely responsive with different view for different sizes. And the app works live so feel free to test and upload a post and like and comment some of my posts.",viewLive:"https://instagram.siwani.com.np/"},
