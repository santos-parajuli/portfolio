...
export default function Resume() {
    ...
    const projectData=[
        {image:"https://i.imgur.com/MVoOWRH.gifv",name:"Instagram Clone",desc:"The project is build with ReactJs, TailwindCSS and Firebase. As the name suggests it's a clone of instagram where you can create account, add post, likes, comment and edit profile for now.",viewLive:"https://instagram.siwani.com.np/"},
